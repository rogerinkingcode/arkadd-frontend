...
export default function PrintAllTabsButtonManualReport({ tabContainerIds, buttonText = "📋 Exportar Todas as Abas" }: PrintAllTabsButtonProps) {
    ...
    return (
        <Button variant="default" className="bg-primary text-white hover:bg-primary/90 rounded-lg" ref={buttonRef} onClick={exportAllTabs}>
            {buttonText}
        </Button>
    );
}
